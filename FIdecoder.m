...
df=(fm2-fm1)/ds;
if NR==0
    clear X fm1 fm2 D1_idx D2_idx th
end
...
for k=1:NR
    ...
    FITR0(k) = biasTR^2/(varTR*(nsTR1+nsTR2-2)/(nsTR1+nsTR2-4)) - 2/(0.5*(nsTR1+nsTR2)*ds^2), %*** 2014.04 RCC added: bias correction
    ...
    if opt_save
        ...
        save(fnamesave,'FIVAL0', 'FITR0','weights','Iters','-append')
    end
